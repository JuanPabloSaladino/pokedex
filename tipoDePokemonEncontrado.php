...
<div class="container-fluid">
    <h2 class="text-center text-dark mt-5 mb-3">Lista de Pokemones
        tipo <?php echo $pokemonesPertenecientesAlTipoEncontrado[0][2] ?></h2>
    <div class="row">
        <div class="col-2"></div>
        <div class="col-8">
            <table class="table table-hover table-bordered mt-4 mb-5 rounded table-info">
                ...
                if ($baseDeDatos->conexion->connect_error) {
                    ...
                    foreach ($pokemonesPertenecientesAlTipoEncontrado as $pokemon) {
